...
import pickle
# Haar_Cascade Model
haar = cv2.CascadeClassifier('apps/model/haarcascade_frontalface_default.xml')
# SVM mode
model_SVM = pickle.load(open('apps/model/model_svm.pickle',mode='rb'))
# PCA model
PCA_model = pickle.load(open('apps/model/pca_dict.pickle',mode='rb'))
